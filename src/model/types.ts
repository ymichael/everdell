...
export enum LocationName {
  ...
  FOREST_THREE_RESIN = "FOREST_THREE_RESIN",
  FOREST_PAY_THREE_TWIG_GAIN_THREE_ANY = "FOREST_PAY_THREE_TWIG_GAIN_THREE_ANY",
  FOREST_TWO_RESIN_OR_TWO_BERRY = "FOREST_TWO_RESIN_OR_TWO_BERRY",
}
...
export type CardPaymentOptions = {
  ...
  occupyCardWithGoldenLeaf?: CardName;
